...
public class MessageObject {
    ...
    public boolean isSponsored() {
        return SharedConfig.noAds ? false : sponsoredId != null;
    }
...
//                CodeHighlighting.highlight(spannable, entity.offset, entity.offset + entity.length, entity.language, t, null, true);
    ...
    public void generateLayout(TLRPC.User fromUser) {
        ...
        boolean noforwards = messageOwner != null && messageOwner.noforwards && !SharedConfig.allowScreenshotsInSecret;
        if (!noforwards && !SharedConfig.allowScreenshotsInSecret) {
